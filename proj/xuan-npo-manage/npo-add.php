    ...
    <div class="row d-flex justify-content-center">
        <div class="col-6">
            <div class="card" style=" padding:30px 60px">
                ...
                <h5 class="card-title text-center">先來新增一個主辦單位</h5>


                <!-- 上傳大頭測試區 -->
                <form name="form1" action="npo-add-api.php" method="post" enctype="multipart/form-data" class="image_upload" style="height: 250px; display:none" ;>
                ...
                <div class="card-body mt-4">
                    <form name="form_npo_name" onsubmit="sendData();return false;" novalidate>
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control-lg form-control  " id="name" name="name" placeholder="請填寫主辦單位名稱" required>
                            <!-- 這邊是錯誤時跳出的提示通知 -->
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control-lg form-control " id=" email" name="email" placeholder="請填寫Email" required>
                            <div class="form-text"></div>
                        </div>
                        ...
                        <div class=" mb-4 row">
                            ...
                            <div class="col">
                                <input type="text" class="form-control form-control-lg" id="phone" name="phone" placeholder="ex: 00-1234-5678">
                                <div class="form-text"></div>
                            </div>

                            <div class="col">
                                <input type="text" class="form-control form-control-lg" id="mobile" name="mobile" pattern="09\d{8}" placeholder="ex: 0912-345678">
                                <div class="form-text"></div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" name="intro" id="intro" rows="7" placeholder="請填寫主辦單位簡介"></textarea>
                            <div class="form-text"></div>
                        </div>
...
<script>
    ...
    async function sendData() {
        ...
        const r = await fetch('npo-add-api.php', {
            method: 'POST',
            body: fd,
        });
